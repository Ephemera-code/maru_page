...
export default function About() {
    ...
    return (
        <section id="about" className="py-12 md:py-24 min-h-[70vh] md:min-h-screen bg-[#cae794c9] flex flex-col items-center relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 mb-16 text-center max-w-4xl relative z-10">
                ...
                <div className="mt-10 bg-white/30 backdrop-blur-sm p-8 rounded-3xl border border-white/30 shadow-lg text-center">
