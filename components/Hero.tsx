            ...
            <div className="text-center px-4 max-w-6xl mx-auto mt-10 flex flex-col items-center">
                ...
                <div className="relative w-full max-w-4xl px-4">
                    ...
                    <div className="flex w-full pb-2 pt-4  rounded-3xl flex-col items-center gap-6 mt-5 mb-4 max-w-4xl mx-auto ">
                        ...
                        </p><h2 className="text-3xl md:text-7xl font-extrabold text-[#1B4332] tracking-tighter drop-shadow-sm">
                            Nuestras Comidas
                        </h2>
                        <p className="text-sm md:text-2xl text-[#1B4332] font-medium tracking-wide  bg-amber-50/60 backdrop-blur-md px-6 py-2 rounded-3xl border border-white/20 uppercase italic shadow-sm">
                            Produce saciedad debido a la fibra de sus ingredientes (lentejas, arvejas, espinacas, zanahorias, arroz, soja, cebolla, ajo y morrón). Una vez en nuestro organismo, estos generan los prebióticos indispensables para una vida saludable.
                        </p>
                    </div>
